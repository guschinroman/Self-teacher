...
namespace SelfTeacher.Service.Commands.AccountCommands
{
    public class GetAuthVkLinkCommand : Command<string>
    {
        ...
        {
            return $"{_settings.VkAuth.AuthAdress}/?client_id={_settings.VkAuth.VkAppId}&redirect_uri={_settings.VkAuth.RedirectUrl}&response_type=code&display=popup&scope=4194304";
        }
        #endregion
    }
}
